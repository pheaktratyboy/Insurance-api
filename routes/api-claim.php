...
Route::put('claims/approved/{claim}', [ClaimController::class,'approvedClaim'])->name('claim.approved');
Route::put('claims/cancel/{claim}', [ClaimController::class,'cancelClaim'])->name('claim.cancel');
Route::put('claims/rejected/{claim}', [ClaimController::class,'rejectedClaim'])->name('claim.rejected');
